...
export const updateOrderStatus = createServerFn({ method: "POST" })
  .validator(
    z.object({
      ...
      status: z.enum([
        "draft", "awaiting_shipping_quote", "awaiting_payment", "payment_processing",
        "paid", "processing", "ready_for_pickup", "shipped", "delivered",
        "completed", "cancelled", "payment_failed", "return_requested", "returned", "refunded"
      ]),
    })
  )
