...
export const ADMIN_SIDEBAR_NAV: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/admin/cms/paginas", label: "Páginas Institucionais", icon: "FileText" },
      ...
      { path: "/admin/stories", label: "Stories", icon: "Video" },
      ...
      { path: "/admin/configuracoes/seo", label: "SEO Global", icon: "Settings" },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/admin/configuracoes/pagamentos", label: "Pagamentos & Fretes", icon: "CreditCard" },
      { path: "/admin/configuracoes/loja", label: "Configurações Globais", icon: "Settings" },
      { path: "/admin/configuracoes/politicas", label: "Políticas Legais", icon: "FileText" },
      { path: "/admin/configuracoes/lgpd", label: "Controle LGPD", icon: "CheckSquare" },
      { path: "/admin/configuracoes/auditoria", label: "Auditoria", icon: "FileText" },
      { path: "/admin/configuracoes/etapas", label: "Etapas de Setup", icon: "CheckSquare" },
    ],
  },
];
