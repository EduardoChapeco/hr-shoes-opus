            ...
            <div className="bg-muted/50 p-3 rounded-md flex items-start gap-3 border border-border">
              ...
              <div className="text-sm">
                ...
                <p className="text-muted-foreground text-xs mt-1">
                  {aspect === 21 / 9
                    ? "Para banners full-width, use imagens de pelo menos 1920x800 pixels para evitar perda de qualidade em telas grandes."
                    : aspect === 4 / 5
                      ? "Para produtos ou retratos, use 1080x1350 pixels (padrão de redes sociais)."
                      : aspect === 1
                        ? "Para grade quadrada, use 1080x1080 pixels."
